...
$user_name = 'Ryazanova Ekaterina'; // укажите здесь ваше имя
?>
<!DOCTYPE html>
<html lang="ru">
<head>
...
<main class="container">
    ...
    [
        ...
        'category' => 'Разное',
        'price' => '5400',
        'picture_adress' => 'img/lot-6.jpg',
    ]
    ];
    ?>
        <ul class="lots__list">
            <?php foreach ($pruduct_list as $key => $item): ?>
            <!--заполните этот список из массива с товарами-->
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$item['picture_adress']; ?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
